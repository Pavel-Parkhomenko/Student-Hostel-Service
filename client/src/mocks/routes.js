export const ROUTES_MENTOR = [
  ...
  {path: "/mentor/chat", breadcrumb: "Чат"},
  {path: "/mentor/chat/create", breadcrumb: "Создать"},
...
export const ROUTES_STUDENT = [
  ...
  {path: "/student/pay-hostel", breadcrumb: "Отчет об оплате"},
...
export const ROUTES_ADMIN = [
  ...
  {path: "/admin/employee/create", breadcrumb: "Новый сотрудник"},
